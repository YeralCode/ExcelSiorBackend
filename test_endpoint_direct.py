#!/usr/bin/env python3
"""
Script para probar directamente el endpoint de DIAN disciplinarios.
"""
...
def test_dian_disciplinarios_endpoint():
    """Prueba el endpoint de DIAN disciplinarios con el archivo del usuario."""
    
    logger.info("=== PRUEBA DIRECTA DEL ENDPOINT DIAN DISCIPLINARIOS ===")
    
    # URL del endpoint
    url = "http://localhost:8000/normalizar/Dian/disciplinarios/upload/"
    
    # Ruta del archivo del usuario
    file_path = "/home/yeraldode/Descargas/consolidado_2021_disciplinarios"
        ...
        with open(file_path, 'rb') as f:
            ...
            if response.status_code == 200:
                ...
                with zipfile.ZipFile(output_path, 'r') as zipf:
                    ...
                    # Extraer y revisar el archivo de errores si existe
                    for file_name in file_list:
                        if 'errores' in file_name.lower():
                            ...
                            # Leer el contenido del archivo de errores
                            ...
                            if error_content.strip():
                                ...
                                logger.warning("Primeras 500 caracteres del archivo de errores:")
                                logger.warning(error_content[:500])
                            else:
...
if __name__ == "__main__":
    logger.info("Iniciando pruebas del endpoint...")
