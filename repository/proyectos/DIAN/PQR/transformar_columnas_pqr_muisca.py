...
REFERENCE_HEADERS = [
    'NOMBRE_ARCHIVO',
    'MES_REPORTE',"IDE_EXPEDIENTE", "NUM_IDENT", "PRI_APELL", "SEG_APELL", "RAZ_SOCIAL",
    "MUNICIPIO", "FEC_CREACION", "MEDIO_INGRESO", "CLASIFICACION", "TEMA",
    "SUBTEMA", "OTRA", "TIPO", "CALIDAD_QUIEN_IN_SOLICI", "ESTADO_SOLICITUD",
    "DIR_SECCIONAL_INGRESO", "EVENTO_ACTUAL", "FUNCI_QUE_LA_TIENE_ASIG",
    "ROL_DEL_FUNCIONARIO", "FEC_ASIGNACION_COMP", "DIR_SECCIONAL_ASIGNADO",
...
class CSVProcessor:
    def __init__(self, validator=None):
        ...
        self.error_messages = {
            ...
            'invalid_calidad_quien_solicito': "No se encuentra en calidad_quien_solicito departamento",
            'invalid_clasificacion': "No se encuentra en clasificacion ciudad",
            'invalid_estado_solicitud': "No se encuentra en estado_solicitud ",
    ...
    def _validate_value(self, value: str, expected_type: str, col_name: str, 
        ...
        try:
            validation_methods = {
                ...
                "choice_clasificacion_muisca": ("validar_clasificacion", "invalid_clasificacion"),
                "choice_calidad_quien_solicito": ("validar_calidad_quien_solicito", "calidad_quien_solicito"),
                "choice_direccion_seccional": ("validar_direccion_seccional", "invalid_direccion_seccional"),
                "choice_estado_solicitud": ("validar_estado_solicitud", "invalid_estado_solicitud"),
            }
...
if __name__ == "__main__":
    from validadores.validadores_pqr_muisca import ValidadoresPQRMuisca
    ...
    "datetime": [],
    "str": [
        3, 5, 6, 7, 8, 10, 12, 13, 14, 15, 19, 20, 21, 22, 24, 25, 26, 27, 28, 30, 31
    ],
    ...
    base_path = os.path.expanduser("~/Documentos/ITRC/DOCUMENTOS_LIMPIAR/copia_DIAN_PQRS/2024/MUISCA/CSV/")
    input_file = os.path.join(base_path, "consolidado_2024_dian_pqr_muisca.csv")
    output_file = os.path.join(base_path, "consolidado_2024_dian_pqr_muisca_procesado.csv")
